...
public:
    ...
    {	
        return (m_bzip2_stream.total_in_hi32 << 32) 
                + m_bzip2_stream.total_in_lo32;
    }
	long get_out_size() const				
    {	
        return (m_bzip2_stream.total_out_hi32 << 32) 
...
public:
	...
	: bzip2_ostreambase_type(ostream_,block_size_100k_, verbosity_, work_factor_,buffer_size_), ostream_type(rdbuf())
	{
	...
	{	
        ...
        void close() { bzip2_ostreambase_type::close(); }
};
...
public:
	...
	basic_bzip2_istream( 
	  ...
	  : bzip2_istreambase_type(istream_,verbosity_, small_, read_buffer_size_, input_buffer_size_), istream_type(rdbuf())
	{};
        void close() { bzip2_istreambase_type::close(); }
};
...
#include "bzip2stream.ih"

#endif //BZIP2STREAM_HPP
